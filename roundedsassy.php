...
class Skinroundedsassy extends SkinTemplate {
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'roundedsassy/main.css', 'screen' );
		if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( $wgHandheldStyle, 'handheld' );
		}

		$out->addStyle( 'roundedsassy/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
		$out->addStyle( 'roundedsassy/IE55Fixes.css', 'screen', 'IE 5.5000' );
		$out->addStyle( 'roundedsassy/IE60Fixes.css', 'screen', 'IE 6' );
		$out->addStyle( 'roundedsassy/IE70Fixes.css', 'screen', 'IE 7' );
		$out->addStyle( 'roundedsassy/IE80Fixes.css', 'screen', 'IE 8' );

		$out->addStyle( 'roundedsassy/rtl.css', 'screen', '', 'rtl' );
	}
}
	...
	<div id="p-search" class="portlet">
		...
		<div id="searchBody" class="pBody">
			<form action="<?php $this->text('wgScript') ?>" id="searchform"><div>
				...
				<img src="skins/roundedsassy/magnifyingglass.gif" alt="search" /><input id="searchInput" name="search" type="text"<?php echo $this->skin->tooltipAndAccesskey('search');
					if( isset( $this->data['search'] ) ) {
						?> value="<?php $this->text('search') ?>"<?php } ?> />
				<input type='image' name="go" class="searchButton" id="searchGoButton"	value="<?php $this->msg('searcharticle') ?>" src="skins/roundedsassy/go.gif" <?php echo $this->skin->tooltipAndAccesskey( 'search-go' ); ?> /><?php if ($wgUseTwoButtonsSearchForm) { ?>&nbsp;
				<input type='image' name="fulltext" class="searchButton" id="mw-searchButton" value="<?php $this->msg('searchbutton') ?>" src="skins/roundedsassy/search.gif" <?php echo $this->skin->tooltipAndAccesskey( 'search-fulltext' ); ?> /><?php } else { ?>
